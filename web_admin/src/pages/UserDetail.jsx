...
import devicesList from "../assets/JsonData/devices-list-by-user.json";
    ...
    <div>
      <div>
        ...
        <div className="card">
          <div className="row">
            <div>Tên: </div>
            <div style={{marginLeft: '10px'}}>Giang Nguyen</div>
          </div>
          <div className="row">
            <div>Email: </div>
            <div style={{marginLeft: '10px'}}>giangnguyen@gmail.com</div>
          </div>
          <div className="row">
            <div>Số điện thoại: </div>
            <div style={{marginLeft: '10px'}}>0987654321</div>
          </div>
          <div className="row">
            <div>Địa điểm: </div>
            <div style={{marginLeft: '10px'}}>Phòng 3 tòa AC</div>
          </div>
        </div>
      </div>
