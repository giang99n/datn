...
import 'package:iot_demo/ui/home/room_screen.dart';
        ...
        children: [
          GestureDetector(
            onTap: (){
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => LivingRoomScreen(room: Room.livingRoom,)),
              );
            },
            child: Container(
          ...
          GestureDetector(
            onTap: (){
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => LivingRoomScreen(room: Room.kitchen)),
              );
            },
            child: Container(
              margin: const EdgeInsets.fromLTRB(5,10,0,0),
